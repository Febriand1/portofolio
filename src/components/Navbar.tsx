...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-card-custom border-b border-border-light">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
                ...
                className={({ isActive }) =>
                  `text-sm font-medium font-sans py-1 transition-colors relative focus:outline-none focus:ring-2 focus:ring-brand rounded ${
                    isActive
                      ...
                      : 'text-neutral-600 dark:text-neutral-300 hover:text-neutral-dark'
                  }`
                }
              >
                {item.name}
          ...
          <div className="flex items-center space-x-3 border-l border-border-light pl-6">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 border border-border-light hover:bg-neutral-light text-neutral-600 dark:text-neutral-300 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-brand"
            ...
            <button
              ...
              className="px-2.5 py-1 text-xs font-semibold border border-border-light hover:bg-neutral-light text-neutral-600 dark:text-neutral-300 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-brand"
      ...
      {isOpen && (
        <div
          className="md:hidden border-b border-border-light bg-card-custom"
          id="mobile-menu"
        >
